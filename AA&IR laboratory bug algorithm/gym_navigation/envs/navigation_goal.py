...
class NavigationGoal(Navigation):
    ...
    def perform_action(self, action: int) -> None:
        if action == 0:
            ...
            if self.last_action_performed == 0:
                ...
                #  self.circumnavigation_terminated = False
            else:
    ...
    def move_tangent_to_obsatcle(self) -> None:
        ...
        shift_closer = distance_after_shift - 1.4
        self.pose.shift(shift_closer, 0.0)


    def get_observation(self) -> int:
        # return the id of the too much near obstacle or -1
        index = -1
        # if self.circumnavigation_terminated:
        ...
        # else:
        #     index = self.nearer_obstacle_index
